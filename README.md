...
(ADR-0007), not while developing. [docs/rules.md](docs/rules.md) is the concept and ruleset players
and agents read, [docs/modstack.md](docs/modstack.md) records candidate versions and the config we
